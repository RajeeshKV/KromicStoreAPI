...
namespace KromicStore.Infrastructure.Migrations
{
    ...
    [Migration("20260729123909_AddSocialMediaUrlsToStorefront")]
    partial class AddSocialMediaUrlsToStorefront
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KromicStore.Domain.Entities.Courier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KromicStore.Domain.Entities.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KromicStore.Domain.Entities.RazorpayConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RazorpayConfigurations");
                });
            ...
            modelBuilder.Entity("KromicStore.Domain.Entities.Theme", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KromicStore.Domain.Entities.ProductImage", b =>
                {
                    b.HasOne("KromicStore.Domain.Entities.Product", null)
                        .WithMany("Images")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KromicStore.Domain.Entities.Product", "Product")
                        .WithMany()
